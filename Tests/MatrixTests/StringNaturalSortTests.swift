...
//
//  Ported from PopulationGenetics' NaturalSortTests.swift.
//
...
struct StringNaturalSortTests {

    // MARK: - naturalCompare / naturalSorted

    @Test func sortsMixedNumericAndAlphabeticCodesNumericallyThenAlphabetically() async throws {
        // Lexicographic sort would put "12" before "2" and "160" before "9";
        // natural sort must not.
        let values = [
